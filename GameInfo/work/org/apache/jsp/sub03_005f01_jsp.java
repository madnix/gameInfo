...
public final class sub03_005f01_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  int limit=((Integer)request.getAttribute("limit")).intValue();
      ...
      out.write("<title>플레이스테이션 커뮤니티</title>\r\n");
 ...
 if(session.getAttribute("userstate")!=null&&session.getAttribute("userstate").equals("admin")){ 
      ...
      out.write("              <tr>\r\n");
      out.write("                <td width=\"250\" height=\"200\"><img src=\"images/sub03_01/03_sub_01_05.png\" width=\"250\" height=\"200\" /></td>\r\n");
      out.write("              </tr>\r\n");
      out.write("              <tr>\r\n");
 ...
 if(startpage != 1) {
      ...
      out.write("\r\n");
      out.write("    <a href=\"com_ps_list.info?page=");
      out.print(startpage);
      out.write("\"><img src=\"");
      out.print(request.getContextPath() );
...
out.println("<font color=#5d5d5d size=2 face=굴림체><b>" + a + "&nbsp;</b></font>"); 
      ...
      out.write("\r\n");
      out.write("    \t <a class=\"board_paging\" href=\"com_ps_list.info?page=");
      out.print(a);
      out.write('"');
      out.write('>');
      out.print(a);
 ...
 if(maxpage != maxpage) {
      ...
      out.write("     <form name=\"find\" method=\"post\" action=\"com_ps_find.info\" onsubmit=\"return find_check()\">\r\n");
      out.write("       <table>\r\n");
    ...
    if(grade.equals("0") || grade.equals("admin")){
      ...
      out.write("\r\n");
      out.write("    <a href=\"com_ps_write.info\" onfocus=\"this.blur()\"><img src=\"");
      out.print(request.getContextPath());
