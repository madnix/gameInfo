...
public final class sub03_005f02_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  int limit=((Integer)request.getAttribute("limit")).intValue();
      ...
      out.write("<title>엑스박스 커뮤니티</title>\r\n");
 ...
 if(session.getAttribute("userstate")!=null&&session.getAttribute("userstate").equals("admin")){ 
      ...
      out.write("              <tr>\r\n");
      out.write("                <td width=\"250\" height=\"200\"><img src=\"images/sub03_02/03_sub_02_05.png\" width=\"250\" height=\"200\" /></td>\r\n");
      out.write("              </tr>\r\n");
      out.write("              <tr>\r\n");
      ...
      out.write("                  <param name=\"movie\" value=\"media/navi/sub03_navi.swf\" />\r\n");
      out.write("                  <param name=\"quality\" value=\"high\" />\r\n");
      out.write("                  <embed src=\"media/navi/sub03_navi.swf\" quality=\"high\" pluginspage=\"http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash\" type=\"application/x-shockwave-flash\" width=\"250\" height=\"430\"></embed>\r\n");
      out.write("                </object></noscript></td>\r\n");
      out.write("              </tr>\r\n");
      out.write("            </table></td>\r\n");
    ...
    for(int i=0;i<bbsList.size();i++){
      ...
      out.write("          href=\"");
      out.print(request.getContextPath() );
      out.write("/com_xbox_cont.info?no=");
      out.print(b.getNo());
      out.write("\">\r\n");
      out.write("          ");
 ...
 if(startpage != 1) {
      ...
      out.write("\r\n");
      out.write("    <a href=\"com_xbox_list.info?page=");
      out.print(startpage);
      out.write("\"><img src=\"");
      out.print(request.getContextPath() );
...
out.println("<font color=#5d5d5d size=2 face=굴림체><b>" + a + "&nbsp;</b></font>"); 
      ...
      out.write("\r\n");
      out.write("    \t <a class=\"board_paging\" href=\"com_xbox_list.info?page=");
      out.print(a);
      out.write('"');
      out.write('>');
      out.print(a);
 ...
 if(maxpage != maxpage) {
      ...
      out.write("     <form name=\"find\" method=\"post\" action=\"com_xbox_find.info\" onsubmit=\"return find_check()\">\r\n");
      out.write("       <table>\r\n");
    ...
    if(grade.equals("0") || grade.equals("admin")){
      ...
      out.write("\r\n");
      out.write("    <a href=\"com_xbox_write.info\" onfocus=\"this.blur()\"><img src=\"");
      out.print(request.getContextPath() );
