...
public final class com_005fps_005fedit_jsp extends org.apache.jasper.runtime.HttpJspBase
...
BbsBean b = (BbsBean) request.getAttribute("bbsbean");
 ...
 if(session.getAttribute("userstate")!=null&&session.getAttribute("userstate").equals("admin")){ 
      ...
      out.write("                <img src=\"");
      out.print(request.getContextPath());
      out.write("/images/sub03_02/03_sub_02_05.png\" width=\"250\" height=\"200\" />\r\n");
      out.write("                </td>\r\n");
      out.write("              </tr>\r\n");
      out.write("              <tr>\r\n");
      ...
      out.write("              \r\n");
      out.write("  <!-- 내용 작성 영역-->\r\n");
      out.write("\t<form action=\"com_ps_edit.info\" method=\"post\" name=\"editform\" id=\"editform\"\r\n");
      ...
      out.write("\t\t\t\t<input type=\"reset\" value=\"취소\" onclick=\"location='com_ps_list.info'\">\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr> \r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t</form>\r\n");
