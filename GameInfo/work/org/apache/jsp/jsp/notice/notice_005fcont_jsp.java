...
public final class notice_005fcont_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (c != null && c.getCom() != null) {
	String com_cont = c.getCom().replace("\n", "<br>");
      ...
      out.print(request.getContextPath() );
      out.write("/notice_edit.info').submit();\r\n");
      out.write("\t\treturn false;\r\n");
      out.write("\t}\r\n");
      out.write("}\r\n");
      ...
      out.write("\t\t$('#fed').attr('action','");
      out.print(request.getContextPath() );
      out.write("/notice_del.info').submit();\r\n");
      out.write("\t\treturn false;\r\n");
      out.write("\t}\r\n");
      out.write("}\r\n");
      ...
      out.write("\t$('#fed').attr('action','");
      out.print(request.getContextPath() );
      out.write("/notice_recom.info').submit();\r\n");
      out.write("\treturn false;\r\n");
      out.write("}\r\n");
      out.write("function list(){\r\n");
      out.write("\t$('#fed').attr('action','");
      out.print(request.getContextPath() );
      out.write("/notice_list.info').submit();\r\n");
      out.write("\treturn false;\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      ...
      out.print(request.getContextPath() );
      out.write("/notice_com.info').submit();\r\n");
      out.write("\t\treturn false;\r\n");
      out.write("\t}\r\n");
      out.write("}\r\n");
      out.write("</script>\r\n");
 ...
 if(b.getSub_file1() != null) { 
      out.write("\r\n");
      out.write("\t\t\t<a href=\"/GameInfo/noticeupload");
...
int v_no = listcount;
	...
	if (nickname!=null){
      ...
      out.print(request.getContextPath());
      out.write("/notice_comdel.info?bbsno=");
      out.print(b.getNo());
      out.write("&comno=");
      out.print(com.getNo());
      out.write("'; return false;\" />\r\n");
