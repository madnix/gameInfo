...
public final class mem_005fidcheck_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	if (id == null) {
      ...
      out.write("\r\n");
      out.write("\tvar alogin = \"0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ_\";\r\n");
      ...
      out.write("\t\tvar v = form.idcheck.value;\r\n");
      out.write("\t\tvar s = v.substr(0, 1);\r\n");
      out.write("\r\n");
      out.write("\t\tif ($.trim($(\"#idcheck\").val()) == \"\") {\r\n");
      out.write("\t\t\talert(\"아이디를 입력하세요!\");\r\n");
      out.write("\t\t\t$(\"#idcheck\").val(\"\").focus();\r\n");
      out.write("\t\t\treturn false;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tif ($.trim($(\"#idcheck\").val()).length < 4) {\r\n");
      out.write("\t\t\talert(\"아이디는 4자리 이상입니다.\");\r\n");
      out.write("\t\t\t$(\"#idcheck\").val(\"\").focus();\r\n");
      out.write("\t\t\treturn false;\r\n");
      out.write("\t\t} else if ($.trim($(\"#idcheck\").val()).length > 12) {\r\n");
      out.write("\t\t\talert(\"아이디는 12자 이하입니다.\")\r\n");
      out.write("\t\t\t$(\"#idcheck\").val(\"\").focus();\r\n");
      out.write("\t\t\treturn false;\r\n");
      out.write("\t\t} else if (v.length == 0) {\r\n");
      out.write("\t\t\talert(\"원하시는 ID를 입력해 주세요!\");\r\n");
      out.write("\t\t\t$(\"#idcheck\").val(\"\").focus();\r\n");
      out.write("\t\t\treturn false;\r\n");
      ...
      out.write("\t\topener.document.f.join_id.value = id;\r\n");
      ...
      out.print(request.getContextPath() );
      out.write("/mem_idcheck.info\" onsubmit=\"return check(this)\">\r\n");
      out.write("\t\t<table width=\"350\" cellpadding=\"0\" cellspacing=\"0\">\r\n");
      out.write("\t\t<tr> \r\n");
      out.write("  \t\t<td align=\"center\"><img src=\"");
      out.print(request.getContextPath() );
      out.write("/images/images/id_chktop.png\"></td>\r\n");
      out.write(" \t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<div align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t\t<span class=\"checkArea\">아이디검색</span>&nbsp;&nbsp;</span> \r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"idcheck\" id=\"idcheck\" size=\"12\" len=\"4-12\" maxlength=\"12\" class=\"chk_input\" />&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"submit\" value=\"검색\" name=\"chkbutton\" id=\"chkbutton\" onclick=\"return idchk()\" /><br> \r\n");
      out.write("\t\t\t\t\t\t\t<span class=\"checkArea_edit\"><br>* 영문대소문자로 시작해서 숫자조합 4자~12자 입력</span>\r\n");
      out.write("\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t</div></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      ...
      out.write("</b>는 사용하실 수 있는 아이디입니다.\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
