...
if (c != null && c.getCom() != null) {
	String com_cont = c.getCom().replace("\n", "<br>");
      ...
      out.write("<title>XBOX의 게임</title>\r\n");
      ...
      out.write("\tif (name != (\"nickname\")) {\r\n");
      out.write("\t\talert(\"작성자만 내용을 수정할 수 있습니다.\");\r\n");
      ...
      out.print(request.getContextPath() );
      out.write("/qna_edit.info').submit();\r\n");
      out.write("\t\t    return false;\r\n");
      out.write("\t   }\r\n");
      out.write("   }\r\n");
      out.write("}\r\n");
      ...
      out.write("\t$('#fed').attr('action','");
      out.print(request.getContextPath() );
      out.write("/qna_recom.info').submit();\r\n");
      out.write("\treturn false;\r\n");
      out.write("}\r\n");
      out.write("function list(){\r\n");
      out.write("\t$('#fed').attr('action','");
      out.print(request.getContextPath() );
      out.write("/qna_list.info').submit();\r\n");
      out.write("\treturn false;\r\n");
      out.write("}\r\n");
      out.write("\r\n");
 ...
 if(session.getAttribute("userstate")!=null&&session.getAttribute("userstate").equals("admin")){ 
      ...
      out.write("                <img src=\"");
      out.print(request.getContextPath());
      out.write("/images/sub04_01/04_sub_01_05.png\" width=\"250\" height=\"200\" />\r\n");
      out.write("                </td>\r\n");
      out.write("              </tr>\r\n");
      out.write("              <tr>\r\n");
      ...
      out.print(request.getContextPath());
      out.write("/media/navi/sub04_navi','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','");
      out.print(request.getContextPath());
      out.write("/media/navi/sub04_navi' ); //end AC code\r\n");
      ...
      out.write("                  <embed src=\"");
      out.print(request.getContextPath());
      out.write("/media/navi/sub04_navi.swf\" quality=\"high\" pluginspage=\"http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash\" type=\"application/x-shockwave-flash\" width=\"250\" height=\"430\"></embed>\r\n");
      out.write("                </object></noscript></td>\r\n");
      out.write("              </tr>\r\n");
      out.write("            </table></td>\r\n");
 ...
 if(b.getSub_file1() != null) { 
      out.write("\r\n");
      out.write("\t\t\t<a href=\"/GameInfo/qnaupload");
...
int v_no = listcount;
	...
	if (nickname!=null){
      ...
      out.print(request.getContextPath());
      out.write("/qna_comdel.info?bbsno=");
      out.print(b.getNo());
      out.write("&comno=");
      out.print(com.getNo());
      out.write("'; return false;\" />\r\n");
