...
public final class sub04_005f03_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(session.getAttribute("userstate")!=null&&session.getAttribute("userstate").equals("admin")){ 
      ...
      out.write("  <img src=\"");
      out.print(request.getContextPath() );
      out.write("/images/sub04_03/04_sub_03_07.png\" border=\"0\">\r\n");
      out.write("  </h2>\r\n");
      out.write("    \r\n");
 ...
 if(startpage != 1) {
      ...
      out.write("\r\n");
      out.write("    <a href=\"pds_list.info?page=");
      out.print(startpage);
      out.write("\"><img src=\"");
      out.print(request.getContextPath() );
...
out.println("<font color=#5d5d5d size=2 face=굴림체><b>" + a + "&nbsp;</b></font>"); 
      ...
      out.write("\r\n");
      out.write("    \t <a class=\"board_paging\" href=\"pds_list.info?page=");
      out.print(a);
      out.write('"');
      out.write('>');
      out.print(a);
 ...
 if(maxpage != maxpage) {
      ...
      out.write("     <form name=\"find\" method=\"post\" action=\"pds_find.info\" onsubmit=\"return find_check()\">\r\n");
      out.write("       <table>\r\n");
   ...
   if(grade.equals("admin")){
      ...
      out.write("\r\n");
      out.write("   \r\n");
      out.write("    <a href=\"pds_write.info\" onfocus=\"this.blur()\"><img src=\"");
      out.print(request.getContextPath() );
