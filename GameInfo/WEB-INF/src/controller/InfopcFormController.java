...
@Controller
public class InfopcFormController {
	...
	@RequestMapping(value = "info_pc_write.info", method = RequestMethod.GET)
	public ModelAndView bbs_write() {

		ModelAndView model = new ModelAndView();
		model.setViewName("info/info_pc_write");

		return model;
	}

	@SuppressWarnings("unused")
	@RequestMapping(value = "/info_pc_write.info", method = RequestMethod.POST)
	public ModelAndView submit(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		response.setContentType("text/html;charset=UTF-8");
		PrintWriter out = response.getWriter();
		BbsBean bbsbean = new BbsBean();
		String saveFolder = "C:/JavaDevProject/Portfolilo/GameInfo/infopcupload";
		...
		this.bbsService.insertInfopc(bbsbean);
		response.sendRedirect("info_pc_list.info");
		return null;
	}

	// 수정

	@RequestMapping(value = "/info_pc_edit.info", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/info_pc_edit.info", method = RequestMethod.POST)
	public ModelAndView edit(HttpServletRequest request,
		...
		this.bbsService.editInfopc(bbsbean);
		response.sendRedirect("info_pc_list.info");
		return null;
	}

	@SuppressWarnings("rawtypes")
	@RequestMapping(value = "info_pc_list.info", method = RequestMethod.GET)
	public ModelAndView bbs_List(HttpServletRequest request,
		...
		int listcount = this.bbsService.getInfopcListCount();

		bbslist = bbsdao.getInfopcList(page, limit);
		...
		model2.setViewName("../sub01_03");
		return model2;

	}

	@RequestMapping(value = "/info_pc_find.info", method = RequestMethod.POST)
	public ModelAndView bbs_find(HttpServletRequest request,
		...
		int listcount = this.bbsService.getInfopcFindCount();
		...
		if (find_field.equals("nickname")) {
			findList = this.bbsService.infopcFind(find_name, page, limit);
		} else {
			findList = this.bbsService.infopcFind2(find_name, page, limit);
		}
		...
		model.setViewName("info/info_pc_find");
		return model;
	}

	@SuppressWarnings("rawtypes")
	@RequestMapping(value = "/info_pc_cont.info", method = RequestMethod.GET)
	public ModelAndView bbs_view(HttpServletRequest request,
		...
		// 댓글
		int listcount = this.bbsService.getInfopcComCount(no);
		List comlist = new ArrayList();

		request.setAttribute("listcount", listcount);

		comlist = bbsdao.getInfopcComList(no);
		...
		bbsbean = (BbsBean) bbsdao.contInfopc(no);

		request.setAttribute("bbsdata", bbsbean);
		request.setAttribute("comdata", combean);

		ModelAndView model2 = new ModelAndView();
		model2.setViewName("info/info_pc_cont");
		return model2;
	}

	@RequestMapping(value = "/info_pc_del.info", method = RequestMethod.GET)
	public ModelAndView bbs_del(HttpServletRequest request,
		...
		if (session.getAttribute("userstate") != null
				&& session.getAttribute("userstate").equals("admin")) {
			this.bbsService.delInfopc(no, checkpwd);
			this.bbsService.infopcComDelAll(no);

			ModelAndView model = new ModelAndView();
			model.setViewName("redirect:/info_pc_list.info");
			return model;
	...
	@RequestMapping(value = "/info_pc_com.info", method = RequestMethod.POST)
	public ModelAndView bbs_com(HttpServletRequest request,
		...
		if (nickname == null) {
			...
			this.bbsService.infopcCom(combean);

			ModelAndView model = new ModelAndView();
			model.setViewName("redirect:/info_pc_cont.info?no=" + no);
			return model;
		}
		return null;
	}

	@RequestMapping(value = "/info_pc_comdel.info", method = RequestMethod.GET)
	public ModelAndView bbs_comdel(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {

		int bbsno = Integer.parseInt(request.getParameter("bbsno"));
		int comno = Integer.parseInt(request.getParameter("comno"));
		this.bbsService.infopcComDel(bbsno, comno);

		ModelAndView model = new ModelAndView();
		model.setViewName("redirect:/info_pc_cont.info?no=" + bbsno);
		return model;
	}

	@RequestMapping(value = "/info_pc_recom.info", method = RequestMethod.GET)
	public ModelAndView bbs_recom(HttpServletRequest request,
		...
		this.bbsService.infopcRecom(no);
