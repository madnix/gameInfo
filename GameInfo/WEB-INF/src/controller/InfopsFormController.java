...
@Controller
public class InfopsFormController {
	...
	@RequestMapping(value = "info_ps_write.info", method = RequestMethod.GET)
	public ModelAndView bbs_write() {

		ModelAndView model = new ModelAndView();
		model.setViewName("info/info_ps_write");

		return model;
	}

	@SuppressWarnings("unused")
	@RequestMapping(value = "/info_ps_write.info", method = RequestMethod.POST)
	public ModelAndView submit(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		response.setContentType("text/html;charset=UTF-8");
		PrintWriter out = response.getWriter();
		BbsBean bbsbean = new BbsBean();
		String saveFolder = "C:/JavaDevProject/Portfolilo/GameInfo/infopsupload";
		...
		this.bbsService.insertInfops(bbsbean);
		response.sendRedirect("info_ps_list.info");
		return null;
	}

	// 수정

	@RequestMapping(value = "/info_ps_edit.info", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/info_ps_edit.info", method = RequestMethod.POST)
	public ModelAndView edit(HttpServletRequest request,
		...
		this.bbsService.editInfops(bbsbean);
		response.sendRedirect("info_ps_list.info");
		return null;
	}

	@SuppressWarnings("rawtypes")
	@RequestMapping(value = "info_ps_list.info", method = RequestMethod.GET)
	public ModelAndView bbs_List(HttpServletRequest request,
		...
		int listcount = this.bbsService.getInfopsListCount();

		bbslist = bbsdao.getInfopsList(page, limit);
		...
		model2.setViewName("../sub01_01");
		return model2;

	}

	@RequestMapping(value = "/info_ps_find.info", method = RequestMethod.POST)
	public ModelAndView bbs_find(HttpServletRequest request,
		...
		int listcount = this.bbsService.getInfopsFindCount();
		...
		if (find_field.equals("nickname")) {
			findList = this.bbsService.infopsFind(find_name, page, limit);
		} else {
			findList = this.bbsService.infopsFind2(find_name, page, limit);
		}
		...
		model.setViewName("info/info_ps_find");
		return model;
	}

	@SuppressWarnings("rawtypes")
	@RequestMapping(value = "/info_ps_cont.info", method = RequestMethod.GET)
	public ModelAndView bbs_view(HttpServletRequest request,
		...
		// 댓글
		int listcount = this.bbsService.getInfopsComCount(no);
		List comlist = new ArrayList();

		request.setAttribute("listcount", listcount);

		comlist = bbsdao.getInfopsComList(no);
		...
		bbsbean = (BbsBean) bbsdao.contInfops(no);

		request.setAttribute("bbsdata", bbsbean);
		request.setAttribute("comdata", combean);

		ModelAndView model2 = new ModelAndView();
		model2.setViewName("info/info_ps_cont");
		return model2;
	}

	@RequestMapping(value = "/info_ps_del.info", method = RequestMethod.GET)
	public ModelAndView bbs_del(HttpServletRequest request,
		...
		if (session.getAttribute("userstate") != null
				&& session.getAttribute("userstate").equals("admin")) {
			this.bbsService.delInfops(no, checkpwd);
			this.bbsService.infopsComDelAll(no);

			ModelAndView model = new ModelAndView();
			model.setViewName("redirect:/info_ps_list.info");
	...
	@RequestMapping(value = "/info_ps_com.info", method = RequestMethod.POST)
	public ModelAndView bbs_com(HttpServletRequest request,
		...
		if (nickname == null) {
			...
			this.bbsService.infopsCom(combean);

			ModelAndView model = new ModelAndView();
			model.setViewName("redirect:/info_ps_cont.info?no=" + no);
			return model;
		}
		return null;
	}

	@RequestMapping(value = "/info_ps_comdel.info", method = RequestMethod.GET)
	public ModelAndView bbs_comdel(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {

		int bbsno = Integer.parseInt(request.getParameter("bbsno"));
		int comno = Integer.parseInt(request.getParameter("comno"));
		this.bbsService.infopsComDel(bbsno, comno);

		ModelAndView model = new ModelAndView();
		model.setViewName("redirect:/info_ps_cont.info?no=" + bbsno);
		return model;
	}

	@RequestMapping(value = "/info_ps_recom.info", method = RequestMethod.GET)
	public ModelAndView bbs_recom(HttpServletRequest request,
		...
		this.bbsService.infopsRecom(no);
