...
public class EventFormController {
	...
	@RequestMapping(value = "event_write.info", method = RequestMethod.GET)
	public ModelAndView bbs_write() {

		ModelAndView model = new ModelAndView();
		model.setViewName("notice/event_write");

		return model;
	}

	@SuppressWarnings("unused")
	@RequestMapping(value = "/event_write.info", method = RequestMethod.POST)
	public ModelAndView submit(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		response.setContentType("text/html;charset=UTF-8");
		PrintWriter out = response.getWriter();
		BbsBean bbsbean = new BbsBean();
		String saveFolder = "C:/JavaDevProject/Portfolilo/GameInfo/eventupload";
		...
		this.bbsService.insertevent(bbsbean);
		response.sendRedirect("event_list.info");
		return null;
	}

	// 수정

	@RequestMapping(value = "/event_edit.info", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/event_edit.info", method = RequestMethod.POST)
	public ModelAndView edit(HttpServletRequest request,
		...
		this.bbsService.editevent(bbsbean);
		response.sendRedirect("event_list.info");
		return null;
	}

	@SuppressWarnings("rawtypes")
	@RequestMapping(value = "event_list.info", method = RequestMethod.GET)
	public ModelAndView bbs_List(HttpServletRequest request,
		...
		int listcount = this.bbsService.geteventListCount();

		bbslist = bbsdao.geteventList(page, limit);
		...
		model2.setViewName("../sub02_02");
		return model2;

	}

	@RequestMapping(value = "/event_find.info", method = RequestMethod.POST)
	public ModelAndView bbs_find(HttpServletRequest request,
		...
		int listcount = this.bbsService.geteventFindCount();
		...
		if (find_field.equals("nickname")) {
			findList = this.bbsService.eventFind(find_name, page, limit);
		} else {
			findList = this.bbsService.eventFind2(find_name, page, limit);
		}
		...
		model.setViewName("notice/event_find");
		return model;
	}

	@SuppressWarnings("rawtypes")
	@RequestMapping(value = "/event_cont.info", method = RequestMethod.GET)
	public ModelAndView bbs_view(HttpServletRequest request,
		...
		// 댓글
		int listcount = this.bbsService.geteventComCount(no);
		List comlist = new ArrayList();

		request.setAttribute("listcount", listcount);

		comlist = bbsdao.geteventComList(no);
		...
		bbsbean = (BbsBean) bbsdao.contevent(no);

		request.setAttribute("bbsdata", bbsbean);
		request.setAttribute("comdata", combean);

		ModelAndView model2 = new ModelAndView();
		model2.setViewName("notice/event_cont");
		return model2;
	}

	@RequestMapping(value = "/event_del.info", method = RequestMethod.GET)
	public ModelAndView bbs_del(HttpServletRequest request,
		...
		if (session.getAttribute("userstate") != null
				&& session.getAttribute("userstate").equals("admin")) {
			this.bbsService.delevent(no, checkpwd);
			this.bbsService.eventComDelAll(no);

			ModelAndView model = new ModelAndView();
			model.setViewName("redirect:/event_list.info");
			return model;
	...
	@RequestMapping(value = "/event_com.info", method = RequestMethod.POST)
	public ModelAndView bbs_com(HttpServletRequest request,
		...
		if (nickname == null) {
			...
			this.bbsService.eventCom(combean);

			ModelAndView model = new ModelAndView();
			model.setViewName("redirect:/event_cont.info?no=" + no);
			return model;
		}
		return null;
	}

	@RequestMapping(value = "/event_comdel.info", method = RequestMethod.GET)
	public ModelAndView bbs_comdel(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {

		int bbsno = Integer.parseInt(request.getParameter("bbsno"));
		int comno = Integer.parseInt(request.getParameter("comno"));
		this.bbsService.eventComDel(bbsno, comno);

		ModelAndView model = new ModelAndView();
		model.setViewName("redirect:/event_cont.info?no=" + bbsno);
		return model;
	}

	@RequestMapping(value = "/event_recom.info", method = RequestMethod.GET)
