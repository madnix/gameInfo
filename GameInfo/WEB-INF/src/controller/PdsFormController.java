...
@Controller
public class PdsFormController {
	...
	@RequestMapping(value = "pds_write.info", method = RequestMethod.GET)
	public ModelAndView bbs_write() {

		ModelAndView model = new ModelAndView();
		model.setViewName("pds/pds_write");

		return model;
	}

	@SuppressWarnings("unused")
	@RequestMapping(value = "/pds_write.info", method = RequestMethod.POST)
	public ModelAndView submit(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		response.setContentType("text/html;charset=UTF-8");
		PrintWriter out = response.getWriter();
		BbsBean bbsbean = new BbsBean();
		String saveFolder = "C:/JavaDevProject/Portfolilo/GameInfo/pdsupload";
		...
		this.bbsService.insertpds(bbsbean);
		response.sendRedirect("pds_list.info");
		return null;
	}

	// 수정

	@RequestMapping(value = "/pds_edit.info", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/pds_edit.info", method = RequestMethod.POST)
	public ModelAndView edit(HttpServletRequest request,
		...
		this.bbsService.editpds(bbsbean);
		response.sendRedirect("pds_list.info");
		return null;
	}

	@SuppressWarnings("rawtypes")
	@RequestMapping(value = "pds_list.info", method = RequestMethod.GET)
	public ModelAndView bbs_List(HttpServletRequest request,
		...
		int listcount = this.bbsService.getpdsListCount();

		bbslist = bbsdao.getpdsList(page, limit);
		...
		model2.setViewName("../sub04_03");
		return model2;

	}

	@RequestMapping(value = "/pds_find.info", method = RequestMethod.POST)
	public ModelAndView bbs_find(HttpServletRequest request,
		...
		int listcount = this.bbsService.getpdsFindCount();
		...
		if (find_field.equals("nickname")) {
			findList = this.bbsService.pdsFind(find_name, page, limit);
		} else {
			findList = this.bbsService.pdsFind2(find_name, page, limit);
		}
		...
		model.setViewName("pds/pds_find");
		return model;
	}

	@SuppressWarnings("rawtypes")
	@RequestMapping(value = "/pds_cont.info", method = RequestMethod.GET)
	public ModelAndView bbs_view(HttpServletRequest request,
		...
		// 댓글
		int listcount = this.bbsService.getpdsComCount(no);
		List comlist = new ArrayList();

		request.setAttribute("listcount", listcount);

		comlist = bbsdao.getpdsComList(no);
		...
		bbsbean = (BbsBean) bbsdao.contpds(no);

		request.setAttribute("bbsdata", bbsbean);
		request.setAttribute("comdata", combean);

		ModelAndView model2 = new ModelAndView();
		model2.setViewName("pds/pds_cont");
		return model2;
	}

	@RequestMapping(value = "/pds_del.info", method = RequestMethod.GET)
	public ModelAndView bbs_del(HttpServletRequest request,
		...
		if (session.getAttribute("userstate") != null
				&& session.getAttribute("userstate").equals("admin")) {
			this.bbsService.delpds(no, checkpwd);
			this.bbsService.pdsComDelAll(no);

			ModelAndView model = new ModelAndView();
			model.setViewName("redirect:/pds_list.info");
			return model;
	...
	@RequestMapping(value = "/pds_com.info", method = RequestMethod.POST)
	public ModelAndView bbs_com(HttpServletRequest request,
		...
		if (nickname == null) {
			...
			this.bbsService.pdsCom(combean);

			ModelAndView model = new ModelAndView();
			model.setViewName("redirect:/pds_cont.info?no=" + no);
			return model;
		}
		return null;
	}

	@RequestMapping(value = "/pds_comdel.info", method = RequestMethod.GET)
	public ModelAndView bbs_comdel(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {

		int bbsno = Integer.parseInt(request.getParameter("bbsno"));
		int comno = Integer.parseInt(request.getParameter("comno"));
		this.bbsService.pdsComDel(bbsno, comno);

		ModelAndView model = new ModelAndView();
		model.setViewName("redirect:/pds_cont.info?no=" + bbsno);
		return model;
	}

	@RequestMapping(value = "/pds_recom.info", method = RequestMethod.GET)
