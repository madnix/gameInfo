...
public class NoticeFormController {
	...
	@RequestMapping(value = "notice_write.info", method = RequestMethod.GET)
	public ModelAndView bbs_write() {

		ModelAndView model = new ModelAndView();
		model.setViewName("notice/notice_write");

		return model;
	}

	@SuppressWarnings("unused")
	@RequestMapping(value = "/notice_write.info", method = RequestMethod.POST)
	public ModelAndView submit(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		response.setContentType("text/html;charset=UTF-8");
		PrintWriter out = response.getWriter();
		BbsBean bbsbean = new BbsBean();
		String saveFolder = "C:/JavaDevProject/Portfolilo/GameInfo/noticeupload";
		...
		this.bbsService.insertnotice(bbsbean);
		response.sendRedirect("notice_list.info");
		return null;
	}

	// 수정

	@RequestMapping(value = "/notice_edit.info", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/notice_edit.info", method = RequestMethod.POST)
	public ModelAndView edit(HttpServletRequest request,
		...
		this.bbsService.editnotice(bbsbean);
		response.sendRedirect("notice_list.info");
		return null;
	}

	@SuppressWarnings("rawtypes")
	@RequestMapping(value = "notice_list.info", method = RequestMethod.GET)
	public ModelAndView bbs_List(HttpServletRequest request,
		...
		bbslist = bbsdao.getnoticeList(page, limit);
		...
		model2.setViewName("../sub02_01");
		return model2;

	}

	@RequestMapping(value = "/notice_find.info", method = RequestMethod.POST)
	public ModelAndView bbs_find(HttpServletRequest request,
		...
		int listcount = this.bbsService.getnoticeFindCount();
		...
		if (find_field.equals("nickname")) {
			findList = this.bbsService.noticeFind(find_name, page, limit);
		} else {
			findList = this.bbsService.noticeFind2(find_name, page, limit);
		}
		...
		model.setViewName("notice/notice_find");
		return model;
	}

	@SuppressWarnings("rawtypes")
	@RequestMapping(value = "/notice_cont.info", method = RequestMethod.GET)
	public ModelAndView bbs_view(HttpServletRequest request,
		...
		// 댓글
		int listcount = this.bbsService.getnoticeComCount(no);
		List comlist = new ArrayList();

		request.setAttribute("listcount", listcount);

		comlist = bbsdao.getnoticeComList(no);
		...
		bbsbean = (BbsBean) bbsdao.contnotice(no);

		request.setAttribute("bbsdata", bbsbean);
		request.setAttribute("comdata", combean);

		ModelAndView model2 = new ModelAndView();
		model2.setViewName("notice/notice_cont");
		return model2;
	}

	@RequestMapping(value = "/notice_del.info", method = RequestMethod.GET)
	public ModelAndView bbs_del(HttpServletRequest request,
		...
		if (session.getAttribute("userstate") != null
				&& session.getAttribute("userstate").equals("admin")) {
			this.bbsService.delnotice(no, checkpwd);
			this.bbsService.noticeComDelAll(no);

			ModelAndView model = new ModelAndView();
			model.setViewName("redirect:/notice_list.info");
	...
	@RequestMapping(value = "/notice_com.info", method = RequestMethod.POST)
	public ModelAndView bbs_com(HttpServletRequest request,
		...
		if (nickname == null) {
			...
			this.bbsService.noticeCom(combean);

			ModelAndView model = new ModelAndView();
			model.setViewName("redirect:/notice_cont.info?no=" + no);
			return model;
		}
		return null;
	}

	@RequestMapping(value = "/notice_comdel.info", method = RequestMethod.GET)
	public ModelAndView bbs_comdel(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {

		int bbsno = Integer.parseInt(request.getParameter("bbsno"));
		int comno = Integer.parseInt(request.getParameter("comno"));
		this.bbsService.noticeComDel(bbsno, comno);

		ModelAndView model = new ModelAndView();
		model.setViewName("redirect:/notice_cont.info?no=" + bbsno);
		return model;
	}

	@RequestMapping(value = "/notice_recom.info", method = RequestMethod.GET)
	public ModelAndView bbs_recom(HttpServletRequest request,
		...
		this.bbsService.noticeRecom(no);
