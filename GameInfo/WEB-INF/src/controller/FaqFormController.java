...
public class FaqFormController {
	...
	@RequestMapping(value = "faq_write.info", method = RequestMethod.GET)
	public ModelAndView bbs_write() {

		ModelAndView model = new ModelAndView();
		model.setViewName("faq/faq_write");

		return model;
	}

	@SuppressWarnings("unused")
	@RequestMapping(value = "/faq_write.info", method = RequestMethod.POST)
	public ModelAndView submit(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {
		response.setContentType("text/html;charset=UTF-8");
		PrintWriter out = response.getWriter();
		BbsBean bbsbean = new BbsBean();
		String saveFolder = "C:/JavaDevProject/Portfolilo/GameInfo/faqupload";
		...
		this.bbsService.insertfaq(bbsbean);
		response.sendRedirect("faq_list.info");
		return null;
	}

	// 수정

	@RequestMapping(value = "/faq_edit.info", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/faq_edit.info", method = RequestMethod.POST)
	public ModelAndView edit(HttpServletRequest request,
		...
		this.bbsService.editfaq(bbsbean);
		response.sendRedirect("faq_list.info");
		return null;
	}

	@SuppressWarnings("rawtypes")
	@RequestMapping(value = "faq_list.info", method = RequestMethod.GET)
	public ModelAndView bbs_List(HttpServletRequest request,
		...
		int listcount = this.bbsService.getfaqListCount();

		bbslist = bbsdao.getfaqList(page, limit);
		...
		model2.setViewName("../sub04_02");
		return model2;

	}

	@RequestMapping(value = "/faq_find.info", method = RequestMethod.POST)
	public ModelAndView bbs_find(HttpServletRequest request,
		...
		int listcount = this.bbsService.getfaqFindCount();
		...
		if (find_field.equals("nickname")) {
			findList = this.bbsService.faqFind(find_name, page, limit);
		} else {
			findList = this.bbsService.faqFind2(find_name, page, limit);
		}
		...
		model.setViewName("faq/faq_find");
		return model;
	}

	@SuppressWarnings("rawtypes")
	@RequestMapping(value = "/faq_cont.info", method = RequestMethod.GET)
	public ModelAndView bbs_view(HttpServletRequest request,
		...
		// 댓글
		int listcount = this.bbsService.getfaqComCount(no);
		List comlist = new ArrayList();

		request.setAttribute("listcount", listcount);

		comlist = bbsdao.getfaqComList(no);
		...
		bbsbean = (BbsBean) bbsdao.contfaq(no);

		request.setAttribute("bbsdata", bbsbean);
		request.setAttribute("comdata", combean);

		ModelAndView model2 = new ModelAndView();
		model2.setViewName("faq/faq_cont");
		return model2;
	}

	@RequestMapping(value = "/faq_del.info", method = RequestMethod.GET)
	public ModelAndView bbs_del(HttpServletRequest request,
		...
		if (session.getAttribute("userstate") != null
				&& session.getAttribute("userstate").equals("admin")) {
			this.bbsService.delfaq(no, checkpwd);
			this.bbsService.faqComDelAll(no);

			ModelAndView model = new ModelAndView();
			model.setViewName("redirect:/faq_list.info");
			return model;
	...
	@RequestMapping(value = "/faq_com.info", method = RequestMethod.POST)
	public ModelAndView bbs_com(HttpServletRequest request,
		...
		if (nickname == null) {
			...
			this.bbsService.faqCom(combean);

			ModelAndView model = new ModelAndView();
			model.setViewName("redirect:/faq_cont.info?no=" + no);
			return model;
		}
		return null;
	}

	@RequestMapping(value = "/faq_comdel.info", method = RequestMethod.GET)
	public ModelAndView bbs_comdel(HttpServletRequest request,
			HttpServletResponse response, HttpSession session) throws Exception {

		int bbsno = Integer.parseInt(request.getParameter("bbsno"));
		int comno = Integer.parseInt(request.getParameter("comno"));
		this.bbsService.faqComDel(bbsno, comno);

		ModelAndView model = new ModelAndView();
		model.setViewName("redirect:/faq_cont.info?no=" + bbsno);
		return model;
	}

	@RequestMapping(value = "/faq_recom.info", method = RequestMethod.GET)
